...
{
    public sealed partial class InductorParametersControl : UserControl, IComponentParameterControl, INotifyPropertyChanged
    {
        ...
        public InductorParametersControl(ElectricComponent ec)
        {
            this.InitializeComponent();
